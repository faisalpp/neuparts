    ...
    <>
      <div className="maincontainer">
        ...
        <div className="mt-6 grid grid-cols-1 items-center gap-10 rounded-lg border border-b3 bg-b3/10 p-6 md:mt-8 md:grid-cols-[220px_auto] md:p-8">
          ...
          <div>
            <div className="inline-flex rounded-lg border border-b2 px-3 py-3 font-semibold text-b2 md:px-4">Appliance Repair and Replacement parts for 234567</div>
            <h2 className="mt-4 text-xl font-bold text-b1 md:text-2xl lg:text-32px">Model Number: 234567</h2>
            <p className="mt-2.5 text-lg font-medium text-b1 md:text-xl 2xl:text-2xl">Frigidaire 24&quot; Front Control Built-In Dishwasher, 62dba - Stainless Steel</p>
          </div>
        </div>
        {/* End Model Details */}
