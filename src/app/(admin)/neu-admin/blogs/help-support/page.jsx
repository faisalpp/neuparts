...
const Page = () => {
  ...
  toast.update(delToastId,{type:toast.TYPE?.PENDING,autoClose:1000,isLoading: true})
    ...
    fetch('/api/admin/blog/help-support', {method: 'DELETE',
 ...
 useEffect(() => {
  ...
  return (
    ...
    <div className='flex flex-col mx-10' style={{height:'calc(100vh - 100px)'}} > 
     <ActionBtns buttons={[{type:'link',text:'Add Blog',link:'/neu-admin/blogs/help-support/add-blog'},{type:'link',text:'Categories',link:'/neu-admin/blogs/help-support/categories'}]}  />
