     ...
     <h1 className="text-center text-xl font-semibold" >Create Review </h1>
      ...
      <div className="flex flex-col gap-3 py-10" >
       ...
       <div>
        ...
        <textarea name="review" value={formData.review} onChange={HandleChange}  className="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-400 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" >
        </textarea>
       </div>
       <div>
