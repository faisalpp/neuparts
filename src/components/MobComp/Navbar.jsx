    ...
    <>
      <div className='sticky top-0 z-50 flex lg:hidden justify-between bg-b1 text-white py-4 px-4 md:px-10' >
        ...
        <div className='gap-8 flex items-center justify-end' >
          ...
          <div onClick={() => { sCart ? '' : '' }} className='relative items-center h-6 w-6 rounded-full text-white' ><AiOutlineShoppingCart className='h-6 w-6' /><span className='absolute -top-2 ml-3 bg-b3 rounded-full text-[10px] py-[2px] px-[6px] text-center' >{cartCount ? cartCount : 0 }</span></div>
          {isUser ?<Link href='/my-account' className='flex items-center bg-b2 h-6 w-6 rounded-full text-white' ><BiUserCircle className='w-6 h-6' /></Link>:<Link href='/login' className='flex items-center bg-b2 h-6 w-6 rounded-full text-white' ><BiUserCircle className='w-6 h-6' /></Link>}
