                ...
                <div className='flex flex-col 2xl:flex-row xl:flex-row gap-4 xl:gap-0 items-start w-full'>
                    ...
                    <div className='grid grid-cols-1 2xl:pl-7 2xl:p-0 gap-4 w-full' >
                        ...
                        <div className='flex items-center gap-x-5' >
                            <span className='font-semibold text-xl text-b3' >${WASHER.isSale ? WASHER.salePrice : WASHER.regPrice}</span>
                            {WASHER.isSale ?<strike className="text-b23" >${WASHER.regPrice}</strike>:null}
                            {WASHER.isSale ? <span className='flex bg-b4 text-xs text-b16 px-2 py-1 font-semibold rounded-full' >-{(100 - (WASHER.salePrice / WASHER.regPrice) * 100).toFixed(0)}%</span>:null}
                        </div>
                        <div className='flex items-center gap-5 2xl:gap-[10px] xl:gap-[5px]' >
                            ...
                            <div className='flex items-center'>
                               <StarIconPrinter numberOfTimes={WASHER.rating} /> 
                            </div>
                        </div>
                        <div className='flex items-center gap-5 2xl:gap-10 xl:gap-4' >
                            ...
                            <h4 className='lg:text-sm text-xs font-medium w-max text-black capitalize' >{WASHER.brand}</h4>
                        </div>
        ...
        <div className='flex flex-col gap-4 items-center w-full h-full' >
         ...
         <div className='flex flex-col items-center justify-center py-10 border-dashed border-2 border-b3 rounded-xl h-full w-full' >
          <div className='flex flex-col items-center space-y-3' >
           ...
           <div className='flex justify-center' ><span className='flex items-center bg-b7 text-xs px-4 py-3 rounded-md text-white font-bold' ><span >Choose A Washer</span><BsArrowRightShort className='text-2xl' /></span></div>
          </div>
         </div>
        </div>
        }
