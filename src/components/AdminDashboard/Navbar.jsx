...
const Navbar = () => {
  ...
  return (
    <nav class="bg-white shadow dark:bg-gray-800 w-full h-fit border-b border-b1">
        ...
        <div class="lg:flex lg:items-center">
            <div class="flex items-center justify-between">
                ...
                <div class="flex lg:hidden">
                    <button onClick={()=>setOpen(isOpen ? false : true)} type="button" class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
