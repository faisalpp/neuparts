...
const CreateTax = ({popup,setPopup}) => {
  ...
  <Popup state={popup} setState={setPopup} >
    <form className='flex flex-col items-center space-y-3 w-full' >
     <h1 className="font-semibold text-center" >Create Tax</h1>
      <div className='flex flex-col items-center space-y-5 w-full' >
       <TextInput title="Tax Name" iscompulsory="true" type="text" value={title} onChange={(e)=>setTitle(e.target.value)}  placeholder="Enter Shipping Zone Name"  />
