...
const Popup = ({ state, setState, children, width, zindex, style,height }) => {
  return (
    <div className={`fixed ${state ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} flex ${style ? style : ''} top-0 justify-center ${zindex ? zindex : 'z-10'} h-screen w-11/12 bg-black bg-opacity-50 transition-opacity duration-300`}>
