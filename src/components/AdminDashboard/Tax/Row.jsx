...
const Row = () => {
  return (
    <tr className="border-b border-l border-r border-b6 text-xs">
        <td className="whitespace-nowrap px-5 py-3 capitalize font-semibold">GST</td>
        <td className="whitespace-nowrap  px-5 py-4 text-b7 font-medium">73301,73302</td>
        <td className="px-5 py-4 text-black font-medium">8.25%</td>
        <td className="px-5 py-4 text-black font-medium">1</td>
