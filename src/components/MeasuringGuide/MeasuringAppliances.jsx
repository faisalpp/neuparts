...
const MeasuringAppliances = () => {
  return (
    <div className="bg-b3/10">
      <div className="maincontainer flex flex-col gap-14 py-16 xl:py-20 2xl:py-120px">
        <h2 className="text-center text-2xl font-bold text-b18 xl:text-[32px]">Measuring Washers and Dryers</h2>
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            <MeasuringCard
              ...
              description={[
                `Washing machines typically have two water fill hoses (hot and cold) and a drain hose. We recommend reserving 2 - 4 inches in depth to account for these. Most washing machine drain pumps are only rated for the drain hose length that comes with the washer. We do not recommend lengthening the drain hose as this can impede the function of the drain, cause clogs or cause damage to the appliance.
