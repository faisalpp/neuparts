  ...
  return (
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 xl:gap-20 2xl:flex">
      <div className={`repairImages ${imagestyle}`}>
        <Image width={800} height={800} quality={100} src={`/appliance/` + image} className="h-auto w-full 2xl:h-full 2xl:w-auto" alt={title} />
      </div>
      <div className="order-2 lg:order-none">
        <div className="inline-flex justify-start">
          <div className="rounded-full border-[1.38569px] border-b3 px-4 py-2">
            <Image width={200} height={200} quality={100} src="/neulogo.webp" alt="neulogo" className="h-[16.536px] w-[92.006px]" />
