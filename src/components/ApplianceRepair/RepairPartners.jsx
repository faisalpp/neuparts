...
const RepairPartners = () => {
  return (
    <>
      <div className="maincontainer pt-5 md:pb-10 lg:pb-16 xl:pb-20">
        <h2 className="text-center text-xl font-bold text-b18 lg:text-2xl xl:text-3xl 2xl:text-[40px]">Our Recommended Repair Partners</h2>
      </div>
      <div className="maincontainer grid grid-cols-1 gap-20 py-10 lg:py-16 xl:py-20 2xl:gap-44 [&>div:nth-child(even)>.repairImages]:order-2">
