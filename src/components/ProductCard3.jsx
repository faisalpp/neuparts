      ...
      {isGrid ? (
        <Link href={`/product/${product.slug}`} className="flex flex-col gap-5 rounded-2xl border border-b16/10 p-2.5 md:p-4 2xl:p-5">
          <div className="relative">
            <Image width={400} height={400} quality={100} src={product.thumbnail} alt={product.title} className={`mx-auto h-32 w-full object-contain md:h-[220px] 2xl:w-2/3 maxmd:p-4`} />
          </div>
